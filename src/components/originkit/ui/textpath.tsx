 ...
 */
export default function TextPath(rawProps: Props) {
    const props = { ...COMPONENT_DEFAULTS, ...rawProps }
    const text = props.text ?? COMPONENT_DEFAULTS.text
    const speed = props.speed ?? COMPONENT_DEFAULTS.speed
    const reversed = props.reversed ?? COMPONENT_DEFAULTS.reversed
    const textFont = props.textFont ?? COMPONENT_DEFAULTS.textFont
    const textColor = props.textColor ?? COMPONENT_DEFAULTS.textColor
    const waveFrequency = props.waveFrequency ?? COMPONENT_DEFAULTS.waveFrequency
    const waveHeight = props.waveHeight ?? COMPONENT_DEFAULTS.waveHeight
    const separator = props.separator ?? COMPONENT_DEFAULTS.separator
    const gap = props.gap ?? COMPONENT_DEFAULTS.gap
    const className = props.className ?? COMPONENT_DEFAULTS.className
    const width = props.width ?? COMPONENT_DEFAULTS.width
    const height = props.height ?? COMPONENT_DEFAULTS.height
